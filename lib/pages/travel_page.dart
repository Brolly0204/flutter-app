...
import '../pages/travel_tab_page.dart';
...
class TravelPage extends StatefulWidget {
  ...
  @override
  State<TravelPage> createState() => _TravelPgeState();
}

class _TravelPgeState extends State<TravelPage> with TickerProviderStateMixin {
  List<TravelTab> tabs = [];
